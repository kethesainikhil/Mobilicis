...
const Footer = () => {
  return (
    <footer
      className="bg-gray-300 text-center   text-black lg:text-left">
      <div
        className="flex flex-col  border-neutral-200 p-6 dark:border-neutral-500">
          ...
          <div className="">
            <h6
              className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
                <title>Mobilicis: Find Job in the World of Japan</title>
            </h6>
            <p className="text-black text-xl font-semibold text-center">
                 Find Your Dream Job in Japan
                <img src={heropage} className="w-44 mx-auto rounded-xl pt-2" alt="" />
